...
class Management:
    def __init__(self, root):
        ...
        # Left Frame
        self.frame_1 = Frame(self.window, bg=color_1)
        self.frame_1.place(x=0, y=0, width=740, relheight = 1)

        # Right Frame
        self.frame_2 = Frame(self.window, bg = color_2)
        self.frame_2.place(x=740,y=0,relwidth=1, relheight=1)

        # Buttons
        self.add_new_bt = Button(self.frame_2, text='Add New', font=(font_1, 12), bd=2, command=self.AddRecord,cursor="hand2", bg=self.color_2,fg=self.color_3).place(x=50,y=40,width=100)
        self.display_bt = Button(self.frame_2, text='Display', font=(font_1, 12), bd=2, command=self.DisplayRecords, cursor="hand2", bg=self.color_2,fg=self.color_3).place(x=50,y=100,width=100)
        self.search_bt = Button(self.frame_2, text='Search', font=(font_1, 12), bd=2, command=self.GetContact_to_Search,cursor="hand2", bg=self.color_2,fg=self.color_3).place(x=50,y=160,width=100)
        self.clear_bt = Button(self.frame_2, text='Clear', font=(font_1, 12), bd=2, command=self.ClearScreen,cursor="hand2", bg=self.color_2,fg=self.color_3).place(x=50,y=340,width=100)
        self.exit_bt = Button(self.frame_2, text='Exit', font=(font_1, 12), bd=2, command=self.Exit, cursor="hand2", bg=self.color_2,fg=self.color_3).place(x=50,y=400,width=100)
        
    '''Double-click on a record'''
    def Selected(self, a):
        self.update_bt = Button(self.frame_2, text='Update', font=(font_1, 12), bd=2, command=self.UpdateData,cursor="hand2", bg=color_6,fg=self.color_3).place(x=50,y=220,width=100)
        self.delete_bt = Button(self.frame_2, text='Delete', font=(font_1, 12), bd=2, command=self.DeleteData,cursor="hand2", bg=color_5,fg=self.color_3).place(x=50,y=280,width=100)
        ...
        if self.name_entry.get() == "" or self.surname_entry.get() == "" or self.addr_entry.get() == "" or self.email_entry.get() == "":
            ...
            try:
                ...
                if row==None:
                    ...
                    if IsValidEmail(self.email_entry.get()):
